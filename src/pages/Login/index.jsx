...
import { VStack, Input, Text, Button, Box, Flex } from "@chakra-ui/react";
  ...
  const submit = async (form) => {
    try {
      ...
      const { data } = await API.graphql(
        graphqlOperation(getTodo, { id: cognitoUser.username })
      );
        ...
        <Box w="full" maxW="600px" mt="6rem">
          <form noValidate onSubmit={handleSubmit(submit)}>
            <VStack spacing="5" px="8">
              ...
              />
              <Button isLoading={loading} type="submit" color="#E09145">
                Log In
              </Button>
